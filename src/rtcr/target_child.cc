...
//	validator_root = new (_md_alloc) Rtcr::Validator_root(_env, _md_alloc, _resource_ep);
...
//	if(validator_root) Genode::destroy(_md_alloc, validator_root);
//	if(validator_service) Genode::destroy(_md_alloc, validator_service);
}
