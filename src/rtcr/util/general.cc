...
void Rtcr::dump_mem(const void *mem, unsigned int size)
{
...
void Rtcr::print_thread_state(Genode::Thread_state &ts, bool brief)
{
	using namespace Genode;
...
void Rtcr::print(Genode::Output &output, Genode::List<STRUCT_INFO> &list)
{
	print(output, "List");
