	...
	_parent_state      (name, weight, utcb, bootstrap_phase)
{
	...
	if(verbose_debug) Genode::log("\033[33m", "Thread", "\033[0m<\033[35m", _name, "\033[0m>(parent ", _parent_cpu_thread,")");
}

Cpu_thread_component::~Cpu_thread_component()
{
	if(verbose_debug) Genode::log("\033[33m", "~Thread", "\033[0m<\033[35m", _name, "\033[0m> ", _parent_cpu_thread);
}
...
{
	if(verbose_debug) Genode::log("Thread<\033[35m", _name, "\033[0m>::\033[33m", __func__, "\033[0m()");
...
{
	if(verbose_debug) Genode::log("Thread<\033[35m", _name, "\033[0m>::\033[33m", __func__, "\033[0m(ip=",
...
{
	if(verbose_debug) Genode::log("Thread<\033[35m", _name, "\033[0m>::\033[33m", __func__, "\033[0m(state<kcap=",
...
{
	if(verbose_debug) Genode::log("Thread<\033[35m", _name, "\033[0m>::\033[33m", __func__, "\033[0m(sigh=", handler, ")");
...
{
	if(verbose_debug) Genode::log("Thread<\033[35m", _name, "\033[0m>::\033[33m", __func__, "\033[0m(", enabled, ")");
...
{
	if(verbose_debug) Genode::log("Thread<\033[35m", _name, "\033[0m>::\033[33m", __func__, "\033[0m(loc<pos=",
